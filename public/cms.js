...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	      ...
	      window.fetch('/data-pages').then(function (response) {
	        ...
	        _this2.setState({
	          ...
	          _this2.content().then(function () {
	            ...
	            _this2.setState({
	              edit: _this2.props.params.item || -1
	            });
	          });
	        });
	      }).catch(function (ex) {
	    ...
	    key: 'save',
	    value: function save(page, update, e) {
	      var _this3 = this;
	      ...
	      page.fields.map(function (field) {
	        row[field.name] = _this3.refs[field.name].value;
	      });
	    ...
	    value: function content() {
	      ...
	      return window.fetch('/get-data/' + this.state.config[this.state.tab].name, {
	        ...
	        _this4.setState({
	          content: _this4.state.content.concat(content),
	          loading: false,
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.state.config.map(function (page, i) {
	            return _react2.default.createElement(
	              _reactRouter.Link,
	              {
	                to: '/admin/' + page.name,
	        ...
	        _react2.default.createElement(
	          ...
	          page ? _react2.default.createElement(
	            ...
	            _react2.default.createElement('br', null),
	            this.state.edit < 0 ? _react2.default.createElement(
	              'button',
	              {
	            ...
	            this.state.edit > -1 && _react2.default.createElement(
	              _reactRouter.Link,
	              {
	                className: 'button',
	            ...
	            _react2.default.createElement('br', null),
	            _react2.default.createElement('br', null),
	            this.state.content.length ? _react2.default.createElement(
	              'div',
	              null,
	              ...
	              this.state.more && _react2.default.createElement(
	                'button',
	                { onClick: this.content.bind(this, this.state.content.length) },
	                'load more'
	              )
	            ) : _react2.default.createElement(
	              'div',
	              null,
	              this.state.loading ? 'Loading...' : 'No content.'
	            )
	          ) : _react2.default.createElement(
	            'div',
	            {
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: '/admin', component: App }),
	  _react2.default.createElement(_reactRouter.Route, { path: '/admin/:page', component: App }),
	  _react2.default.createElement(_reactRouter.Route, { path: '/admin/:page/:item', component: App })
